...
Tags: exit, link, outgoing, external, seo, ads
Requires at least: 3.0
Tested up to: 3.2.1
Stable tag: 1.5

Redirect outgoing links to an Exit Page. Design your exit page for revenues and bookmarks while protecting your SEO with nofollow links

== Description ==

You think youre running your Wordpress site at its full potential? So, whats your Exit Strategy?<br />

What happens when a visitor clicks a link to an external site? They just leave?? Then know that youre leaving money on the table, losing potential customers, and wasting possible social bookmarks.<br />
...
Still dont see why you need a Wordpress Exit Strategy?<br />
...
A Pro version is also available with the following Features:
<ul>
...
3. Go to the new Exit Strategy tab under settings, and start designing your Exit page.